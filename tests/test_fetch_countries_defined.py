...
def test_first_country_is_country():
    assert isinstance(countries[0], Country), "First country should be of type Country"


@pytest.mark.dependency(depends=["test_first_country_is_country"])
